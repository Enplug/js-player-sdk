...
try {
    ...
    console.info('Initializing Web Development Player.', window.location.href, window.location);

    epBridge = {
        send: function send(msg) {
            return parent.postMessage(msg, window.location.origin.replace('apps', 'player'));
        }
    };
